...
Lisez la documentation de la fonction [`fetch`](https://developer.mozilla.org/fr/docs/Web/API/Fetch_API/Using_Fetch) pour comprendre en profondeur comment elle fonctionne, et posez des question !
